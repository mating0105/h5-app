      ...
      helpList: [
        ...
        { title: '4、项目报单流程',
          ...
          list: [
            ...
            { roleName: '风控审批', title: '提交并结束项目报单', content: '审核通过的提交后即可开始垫款/放款流程；审核拒绝的终止结束，不能走后续流程；' }
          ]
        },
        { title: '5、合同签约上传',
          text: '',
        ...
        { title: '6、缴费垫款流程',
          ...
          list: [
            { roleName: '客户经理', title: '发起缴费垫款', content: '风控审批通过后，选择一个项目订单' },
            { roleName: '客户经理', title: '填写垫款信息', content: '填写并确认费用信息、垫款信息、凭证等' },
            { roleName: '客户经理', title: '提交至财务审批', content: '提交前请确保垫款信息的完整性' },
            { roleName: '财务审批', title: '审核垫款信息', content: '审批结论有：退回、拒绝、通过' },
            { roleName: '财务审批', title: '提交并结束缴费垫款', content: '审核通过的提交后即可开始银行放款流程；审核拒绝的终止结束，不能走后续流程；' }
          ]
        },
        { title: '7、银行放款流程',
          text: '缴费垫款和银行放款流程不分先后，人为自行决定',
